...
const Conversation = () => {
    ...
    return (
        <Stack height={"100%"} maxHeight={"100vh"} width={"auto"}>
            {/* chat header */}
            <Box p={2} sx={{ width: "100%", backgroundColor: theme.palette.mode === "light" ? "#f8faff" : theme.palette.background.default, boxShadow: "0px 0px 2px rgba(0, -0, -0, -0.25)" }}>
            ...
            <Box p={2} sx={{ width:"100%", backgroundColor:theme.palette.mode === "light" ? "#f8faff" : theme.palette.background.default, boxShadow: "0px 0px 2px rgba(0, 0, 0, 0.25)" }}>
                <Stack direction={"row"} alignItems="center" spacing={3}>
                    <StyledInput fullWidth variant='filled' placeholder="write a message..." InputProps={{
